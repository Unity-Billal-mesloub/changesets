> [!IMPORTANT]
> This is development branch for Changesets v3. For the v2 code, check out the [maintenance/v2](https://github.com/Unity-Billal-mesloub/changesets/tree/maintenance/v2) branch.
...
- [pnpm](https://pnpm.io)
- [Firebase Javascript SDK](https://github.com/Unity-Billal-mesloub/firebase-js-sdk)
